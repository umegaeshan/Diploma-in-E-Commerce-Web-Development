    ...
    <div class="products">
        <div class="odora-product-grid">
            ...
            <div class="col item1">
                ...
                <!-- MODAL -->
                <div class="modal fade p-5" id="detailsModal_9" tabindex="-1" aria-labelledby="detailsModalLabel_9" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">

                            <div class="modal-header">
                                <h5 class="modal-title" id="detailsModalLabel_9">O3 Freedom Details</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>
